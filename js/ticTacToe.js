...
function topMid(){
  if (game_board[0][1] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("topMid").style.color = "blue";
    }
    else{
      current_marker = x_marker;
      document.getElementById("topMid").style.color = "red";
    }
    document.getElementById("currentplayer").innerHTML = current_player;
  }
}
function topRight(){
  if (game_board[0][2] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("topRight").style.color = "blue";
    }
    else{
      current_marker = x_marker;
...
function midLeft(){
  if (game_board[1][0] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("midLeft").style.color = "blue";
    }
    else{
      current_marker = x_marker;
      document.getElementById("midLeft").style.color = "red";
    }
    document.getElementById("currentplayer").innerHTML = current_player;
  }
}
function midMid(){
  if (game_board[1][1] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("midMid").style.color = "blue";
    }
    else{
      current_marker = x_marker;
      document.getElementById("midMid").style.color = "red";
    }
    document.getElementById("currentplayer").innerHTML = current_player;
  }
}
function midRight(){
  if (game_board[1][2] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("midRight").style.color = "blue";
    }
    else{
      current_marker = x_marker;
      document.getElementById("midRight").style.color = "red";
    }
    document.getElementById("currentplayer").innerHTML = current_player;
  }
}
function botLeft(){
  if (game_board[2][0] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("botLeft").style.color = "blue";
    }
    else{
      current_marker = x_marker;
      document.getElementById("botLeft").style.color = "red";
    }
    document.getElementById("currentplayer").innerHTML = current_player;
  }
}
function botMid(){
  if (game_board[2][1] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("botMid").style.color = "blue";
    }
    else{
      current_marker = x_marker;
      document.getElementById("botMid").style.color = "red";
    }
    document.getElementById("currentplayer").innerHTML = current_player;
  }
}
function botRight(){
  if (game_board[2][2] == "") {
    ...
    if(current_marker == x_marker){
      current_marker = o_marker;
      document.getElementById("botRight").style.color = "blue";
    }
    else{
      current_marker = x_marker;
      document.getElementById("botRight").style.color = "red";
    }
    document.getElementById("currentplayer").innerHTML = current_player;
  }
}
